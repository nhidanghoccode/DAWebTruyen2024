...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])){
        $suatruyen = $tr-> sua_truyenngdung($_POST,$_FILES,$id);
    }
?> 
...
<select class="form-select" id="theloai" name="theloai" >
    ...
    ?>
            ...
            <p>Bìa Truyện</p>
            <img src="../ADMIN/upload/<?php echo $result_truyen['biatruyen']?>" width="90px">
            ...
            <button type="button" class="btn btn-danger"><a href="dstruyendang.php">Trở Về</a></button>
        </form>
    <?php
        }
    }
